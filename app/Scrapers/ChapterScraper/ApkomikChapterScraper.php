...
class ApkomikChapterScraper extends BaseChapterScraper
{
  /**
  ...
  {
    return "https://{$manga->source}/{$manga->slug}/";
  }
  ...
  protected function extractChapterData(DOMXPath $xpath, \DOMNode $element, Manga $manga): ?array
  {
    ...
    // Extract chapter number from the data-num attribute - specific to apkomik.cc
